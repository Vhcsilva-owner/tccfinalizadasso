    ...
    <section className="about" id="sobre">
      <div className="container">
        ...
        <div className="about-intro">
          <p>Há 1 ano oferecendo ajuda e experiências memoráveis para pessoas que precisam de uma nova chance.</p>
        </div>

        <div className="about-features">
          <div className="feature">
            <h3>Ambiente Acolhedor</h3>
            <p>Criamos um ambiente familiar onde quem está sendo ajudado se sinta em casa.</p>
          </div>
          <div className="feature">
